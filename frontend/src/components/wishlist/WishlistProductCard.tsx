    ...
    <div className="group relative flex flex-col justify-between overflow-hidden rounded-2xl border border-emerald-500/15 bg-emerald-950/20 p-5 transition-all hover:bg-emerald-950/40 hover:shadow-lg">
      <div>
        <div className="flex gap-4 mb-4">
          <div className="h-24 w-24 shrink-0 overflow-hidden rounded-xl bg-white/5 p-2 border border-emerald-500/10">
          ...
          <div className="flex flex-col min-w-0 flex-1">
            ...
            <h4 className="text-sm font-medium text-emerald-50 line-clamp-3" title={product.title}>
              {product.title}
            </h4>
          </div>
        </div>
